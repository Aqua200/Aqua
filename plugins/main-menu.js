...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    let pp7 = 'https://qu.ax/zeGSG.gif'
    let pp8 = 'https://qu.ax/zeGSG.gif'
    let pp9 = 'https://qu.ax/zeGSG.gif'
    let pp10 = 'https://qu.ax/zeGSG.gif'
    let pp11 = 'https://qu.ax/zeGSG.gif'
    let pp12 = 'https://qu.ax/zeGSG.gif'
    let pp13 = 'https://qu.ax/zeGSG.gif'
    let pp14 = 'https://qu.ax/zeGSG.gif'
    let pp15 = 'https://qu.ax/zeGSG.gif'
    let gifUrl = "https://qu.ax/kLiRt.jpeg";await conn.sendMessage(m.chat, {video: {url: gifUrl}, gifPlayback: true, caption: text.trim(), mentions: [m.sender]}, {quoted: m});
    await m.react('💌')

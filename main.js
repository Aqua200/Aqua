...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Bot', 'Edge', '2.0.0'] : methodCodeQR ? ['Megumin-Bot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
console.log('Bot no tiene Sub-Bots vinculados.');
return;
}
...
console.log(chalk.bold.greenBright(`Bot conectada correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🍭 Error al iniciar Mia khalifaBot: `, error))
}
})();
